...
handler.all = async function (m) {
	...
	try {
		...
		global.kontak2 = [
         ...
         [owner[1], await this.getName(owner[1] + '@s.whatsapp.net'), 'ɴᴏᴍᴏʀ ʙᴏᴛ ᴡᴀ', 'pangeran.dwnta01@gmail.com', 'Indonesia', true], // Kalo mau di tambah tinggal copy 1baris ini di tempel di bawahnya trs di edit dikit!
        ]
