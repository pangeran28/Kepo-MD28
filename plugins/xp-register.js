...
Dont Call/Vc Bot 
`.trim())
u = '╭─❒ 〔 HALLO NEW PREN 〕\n\n❍ Jika Mau Lebih Tau OwnerKu Klik Tombol "Info Bot"\n❍ Jika Menuju Menu Klik Tombol "Tampilan Menu"\n❍ Jika Mau Cari Nomor OwnerKu Klik Tombol "Pangeran"\n\nPatuhi Rules nya,demi kenyamanan kita bersama.'
await conn.send3But(m.chat, u, wm, 'Info', '#infopangeran', 'Menu', '#menu', 'Pangeran', '#owner',  m)
}
