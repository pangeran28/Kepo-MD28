                ...
                if (chat.welcome) {
                    ...
                    for (let user of participants) {
                        ...
                        try {
                            ...
                            await this.send3TemplateButtonImg(id, action === 'add' ? wel : lea, text, wm, action === 'add' ? 'Selamat Datang Tod' : 'Beban', action === 'add' ? '.intro' : 'Pangeran')
                        }
                    }
                }
                break
...
┗━━━━━━━━━━❑ `
 ...
 if (unreg) return conn.sendButton(m.chat, unreg, '❑ Silahkan Klik reg dibawah ini ❑', 'Register', `.daftar @${m.sender.split`@`[0]}.18`, m)
 }
