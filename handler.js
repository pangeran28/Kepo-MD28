                ...
                if (chat.welcome) {
                    ...
                    for (let user of participants) {
                        ...
                        try {
                            ...
                            await this.send3TemplateButtonImg(id, action === 'add' ? wel : lea, text, wm, action === 'add' ? 'Selamat Datang Tod' : 'Sampai Jumpa Beban', action === 'add' ? '.intro' : 'Pangeran')
                        }
                    }
                }
                break
...
global.dfail = async (type, m, conn) => {
    let msg = {
        ...
        premium: '👤Khusus User _*Premium!*_\n_*Mau Jadi User Premium?*_\n\n_*List User Prems:*_\n_*👤2Minggu/7k*_\n_*👤Sebulan/12k*_\n\n*Selebihnya Chat OwnerKu Tante:*_\nwa.me/6285929970260',
